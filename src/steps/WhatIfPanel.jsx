...
export default function WhatIfPanel() {
  ...
  const wiResults = useMemo(() => runProjection({
    ...
    spouseAnnualContrib401k:  hasSpouse ? Math.round(spouseAnnualContrib401k  * contribScale) : 0,
    spouseEmployerMatch:      hasSpouse ? spouseEmployerMatch : 0,
    spouseAnnualContribIRA:   hasSpouse ? Math.round(spouseAnnualContribIRA   * contribScale) : 0,
    spouseAnnualContribOther: hasSpouse ? Math.round(spouseAnnualContribOther * contribScale) : 0,
    survivorFactor: 1.0,
